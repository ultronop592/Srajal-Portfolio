...
const BentoCard = ({
  ...
  <div
    className={cn(
      ...
      "bg-neutral-900 [box-shadow:0_0_0_1px_rgba(255,255,255,.05),0_2px_4px_rgba(0,0,0,.3),0_12px_24px_rgba(0,0,0,.3)]",
  ...
  >
    ...
    >
      <Button
        ...
        asChild
        size="sm"
        className="pointer-events-auto text-neutral-300 hover:text-white hover:bg-neutral-800"
      >
        <a href={href}>
          {cta}
