            ...
            <div className="flex items-center gap-2">
              {activeItem.href && (
                <Link
                  ...
                  className="group flex items-center gap-2 rounded-full bg-emerald-500 px-5 py-3 text-sm font-semibold text-white transition-transform hover:scale-105 active:scale-95"
                >
                  Demo
              ...
              {activeItem.github && (
                <Link
                  ...
                  className="group flex items-center gap-2 rounded-full bg-emerald-500/20 border border-emerald-500/50 px-5 py-3 text-sm font-semibold text-emerald-300 transition-all hover:bg-emerald-500/30 hover:border-emerald-500 active:scale-95"
                >
