...
// Animation controller - refactored to use requestAnimationFrame
class AnimationController {
  ...
  private startTime = 0
  private duration = 15000 // 15 seconds for full animation cycle
  ...
  private animate = () => {
    ...
    this.time = (elapsed % this.duration) / this.duration
    this.render()
